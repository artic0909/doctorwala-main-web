...
<head>
    <meta charset="utf-8">
    <title>Pathology Page | Doctorwala</title>
    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Pathology Details</h1>
                @guest
                ...
                <a href="" class="h4 text-white">Pathology</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
                ...
                <div class="col-lg-12 wow zoomIn" data-wow-delay="0.3s">
                    <div class="bg-primary my-search-bar2 d-flex flex-column p-5" style="height: 200px;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <a class="btn btn-dark my-search-button" href="">Search Pathology</a>
                            </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="position-relative rounded-top" style="z-index: 1;">
                            <img class="img-fluid rounded-top w-100" src="{{asset('img/Global.png')}}" alt="">
                            <div
