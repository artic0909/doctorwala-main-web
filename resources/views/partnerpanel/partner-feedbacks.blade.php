                        ...
                        <div class="col-md-4 grid-margin">
                            ...
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">User's Feedbacks !</h3>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h3 class="modal-title text-danger" style="font-weight: 700;"><i
                                        class="fa fa-heart text-danger" aria-hidden="true"></i> What Users Say About Us
                                </h3>
