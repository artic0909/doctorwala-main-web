...
<head>
    ...
    <title>Patient Enquiry Details</title>
    <!-- plugins:css -->
                        ...
                        <div class="col-md-12 grid-margin">
                            ...
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Patient Inquiries !</h3>
                                    <h6 class="font-weight-normal mb-0"><span><i class="fa fa-stethoscope text-danger"
                                                aria-hidden="true"></i></span>&nbsp;Here is the list of inquiries
                                        received from individual patients.
                                    </h6>
                                </div>
                            </div>
