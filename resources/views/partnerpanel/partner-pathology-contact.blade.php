...
<head>
    ...
    <title>Pathology Contact Person</title>
    <!-- plugins:css -->
                        ...
                        <div class="col-md-12 grid-margin">
                            ...
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Pathology Contact Person Details Is Here !</h3>
                            ...
                            <div class="row m-auto">
                                <div class="col-12 mt-4">
                                    ...
                                    <form class="prof-view" method="POST" action="{{ route('partner.pathology.contact.store') }}">
                                        @csrf
                                        ...
                                        <div class="from-view row mt-2">
                                            <div class="col-4 form-group">
                                                ...
                                                <input type="text" class="form-control" id="clinic_registration_type" name="clinic_registration_type"
                                                    value="{{ $contactDetails->clinic_registration_type ?? 'Pathology' }}" style="height: 55px;" readonly>
                                            </div>
